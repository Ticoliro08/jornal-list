...
texto4='Parte usada: folhas, frutos e cascas.'
texto5='Povos indígenas brasileiros utilizavam as folhas para banhos terapêuticos e infusões contra febre e infecções leves.'
 img={pitangueira}  />
...
texto4='Parte usada: casca, flores e folhas.'
texto5='Povos nativos adotaram o uso medicinal após a introdução da planta pelos colonizadores. Utilizavam especialmente as folhas em infusões calmantes.'
img={laranja}  />
...
texto4='Parte usada: folhas e flores.'
texto5='Utilizado por povos indígenas da América do Sul para purificação espiritual, banhos medicinais e tratar infecções leves.'
img={manjericao}  />
...
texto4='Parte usada: folhas.'
texto5='Povos indígenas do Chile, como os mapuches, utilizavam o boldo em infusões para tratar problemas hepáticos e como tônico digestivo.'
img={boldo}  />
...
texto4='Parte usada: flores.'
texto5='Embora seja de origem europeia e asiática, povos indígenas brasileiros passaram a usar a camomila após a introdução por colonizadores, especialmente para acalmar crianças, tratar cólicas e como anti-inflamatório leve.'
img={camomila}  />
